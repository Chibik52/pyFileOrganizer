...
class App(CTk):
    ...
    def __init__(self):
        ...
        # self.checks.place(relx=0.5,rely=0.22,anchor=ctk.CENTER)
        ...
        # self.chooseFrame=CTkFrame(self.frame1,fg_color="transparent")
        # # self.chooseFrame.place(relx=0.5,rely=0.65,anchor=ctk.CENTER)
        # self.chooseFrame.grid(row=2,column=0)
